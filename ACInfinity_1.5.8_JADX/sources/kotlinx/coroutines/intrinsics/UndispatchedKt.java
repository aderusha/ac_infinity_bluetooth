        ...
        if (function1 != null) {
            try {
                ...
                if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    probeCoroutineCreated.resumeWith(Result.m1023constructorimpl(invoke));
                }
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                probeCoroutineCreated.resumeWith(Result.m1023constructorimpl(ResultKt.createFailure(th)));
            }
        } else {
