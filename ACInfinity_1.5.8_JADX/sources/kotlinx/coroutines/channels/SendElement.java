...
public class SendElement<E> extends Send {
    ...
    public void resumeSendClosed(Closed<?> closed) {
        ...
        this.cont.resumeWith(Result.m1023constructorimpl(ResultKt.createFailure(sendException)));
    }
