...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public boolean enqueueReceiveInternal(Receive<? super E> receive) {
        ...
        if (isBufferAlwaysEmpty()) {
            ...
            LockFreeLinkedListNode.CondAddOp abstractChannel$enqueueReceiveInternal$$inlined$addLastIfPrevAndIf$1 = new C3816x75f916ce(lockFreeLinkedListNode, this);
            do {
    ...
    public final java.lang.Object m2426receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L_0x0032:
            ...
            java.lang.Object r5 = r0.m2450closedJP2dKIU(r5)
            goto L_0x0052
        L_0x004c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r5 = r0.m2452successJP2dKIU(r5)
        L_0x0052:
            return r5
        L_0x0053:
            r0.label = r3
        ...
        L_0x005c:
            ...
            java.lang.Object r5 = r5.m2449unboximpl()
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.m2426receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public final Object m2427tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        if (pollInternal == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.Companion.m2451failurePtdJZtk();
        }
        if (pollInternal instanceof Closed) {
            return ChannelResult.Companion.m2450closedJP2dKIU(((Closed) pollInternal).closeCause);
        }
        return ChannelResult.Companion.m2452successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        if (closedForSend != null) {
            Object r0 = InlineList.m2474constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
            while (true) {
                LockFreeLinkedListNode prevNode = closedForSend.getPrevNode();
                if (prevNode instanceof LockFreeLinkedListHead) {
                    m2425onCancelIdempotentListww6eGU(r0, closedForSend);
                    return;
                    ...
                    r0 = InlineList.m2479plusFjFbRPM(r0, (Send) prevNode);
                }
            }
        } else {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (z) {
            if (i == 0) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m2437boximpl(ChannelResult.Companion.m2450closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
            }
        } else if (i == 1) {
            ChannelResult.Companion companion = ChannelResult.Companion;
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m2437boximpl(z ? companion.m2450closedJP2dKIU(((Closed) obj).closeCause) : companion.m2452successJP2dKIU(obj)), selectInstance.getCompletion());
        } else {
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuation.resumeWith(Result.m1023constructorimpl(boxBoolean));
                    } else {
                        Throwable receiveException = closed.getReceiveException();
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuation.resumeWith(Result.m1023constructorimpl(ResultKt.createFailure(receiveException)));
                    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m2437boximpl(ChannelResult.Companion.m2452successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                ChannelResult r3 = ChannelResult.m2437boximpl(ChannelResult.Companion.m2450closedJP2dKIU(closed.closeCause));
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m1023constructorimpl(r3));
                return;
            }
            Throwable receiveException = closed.getReceiveException();
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m1023constructorimpl(ResultKt.createFailure(receiveException)));
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m2437boximpl(ChannelResult.Companion.m2452successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m2437boximpl(ChannelResult.Companion.m2450closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), (Function1) null, 4, (Object) null);
                }
            }
        }
    ...
    public void m2425onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj != null) {
