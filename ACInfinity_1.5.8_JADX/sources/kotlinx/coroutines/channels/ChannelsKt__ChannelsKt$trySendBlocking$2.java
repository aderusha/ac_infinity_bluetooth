...
@Metadata(mo27511d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001\"\u0004\b\u0000\u0010\u0003*\u00020\u0004H@"}, mo27512d2 = {"<anonymous>", "Lkotlinx/coroutines/channels/ChannelResult;", "", "E", "Lkotlinx/coroutines/CoroutineScope;"}, mo27513k = 3, mo27514mv = {1, 5, 1}, mo27516xi = 48)
@DebugMetadata(mo28221c = "kotlinx.coroutines.channels.ChannelsKt__ChannelsKt$trySendBlocking$2", mo28222f = "Channels.kt", mo28223i = {}, mo28224l = {92}, mo28225m = "invokeSuspend", mo28226n = {}, mo28227s = {})
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m1023constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m1023constructorimpl(Unit.INSTANCE);
        if (Result.m1030isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m2452successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m2450closedJP2dKIU(Result.m1026exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m2437boximpl(obj3);
    }
}
