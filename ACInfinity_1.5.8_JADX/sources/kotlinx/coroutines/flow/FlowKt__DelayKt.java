...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m2464debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m2419toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m2465sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m2419toDelayMillisLRDsOJo(j));
    }
}
