...
@DebugMetadata(mo28221c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", mo28222f = "Zip.kt", mo28223i = {}, mo28224l = {251}, mo28225m = "invokeSuspend", mo28226n = {}, mo28227s = {})
...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo28221c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", mo28222f = "Zip.kt", mo28223i = {}, mo28224l = {251}, mo28225m = "invokeSuspend", mo28226n = {}, mo28227s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* compiled from: Zip.kt */
    public static final class C38992 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C38992 r0 = new C38992(r3, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C38992((Continuation<? super C38992>) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C38992((Continuation<? super C38992>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
