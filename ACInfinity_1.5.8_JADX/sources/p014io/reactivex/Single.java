...
import p014io.reactivex.internal.fuseable.FuseToMaybe;
import p014io.reactivex.internal.fuseable.FuseToObservable;
import p014io.reactivex.internal.observers.BiConsumerSingleObserver;
import p014io.reactivex.internal.observers.BlockingMultiObserver;
import p014io.reactivex.internal.observers.ConsumerSingleObserver;
import p014io.reactivex.internal.observers.FutureSingleObserver;
import p014io.reactivex.internal.operators.completable.CompletableFromSingle;
import p014io.reactivex.internal.operators.completable.CompletableToFlowable;
...
import p014io.reactivex.internal.operators.maybe.MaybeFilterSingle;
import p014io.reactivex.internal.operators.maybe.MaybeFromSingle;
import p014io.reactivex.internal.operators.mixed.SingleFlatMapObservable;
...
import p014io.reactivex.internal.operators.single.SingleAmb;
import p014io.reactivex.internal.operators.single.SingleCache;
import p014io.reactivex.internal.operators.single.SingleContains;
import p014io.reactivex.internal.operators.single.SingleCreate;
import p014io.reactivex.internal.operators.single.SingleDefer;
import p014io.reactivex.internal.operators.single.SingleDelay;
import p014io.reactivex.internal.operators.single.SingleDelayWithCompletable;
import p014io.reactivex.internal.operators.single.SingleDelayWithObservable;
import p014io.reactivex.internal.operators.single.SingleDelayWithPublisher;
import p014io.reactivex.internal.operators.single.SingleDelayWithSingle;
import p014io.reactivex.internal.operators.single.SingleDematerialize;
import p014io.reactivex.internal.operators.single.SingleDetach;
import p014io.reactivex.internal.operators.single.SingleDoAfterSuccess;
import p014io.reactivex.internal.operators.single.SingleDoAfterTerminate;
import p014io.reactivex.internal.operators.single.SingleDoFinally;
import p014io.reactivex.internal.operators.single.SingleDoOnDispose;
import p014io.reactivex.internal.operators.single.SingleDoOnError;
import p014io.reactivex.internal.operators.single.SingleDoOnEvent;
import p014io.reactivex.internal.operators.single.SingleDoOnSubscribe;
import p014io.reactivex.internal.operators.single.SingleDoOnSuccess;
import p014io.reactivex.internal.operators.single.SingleDoOnTerminate;
import p014io.reactivex.internal.operators.single.SingleEquals;
import p014io.reactivex.internal.operators.single.SingleError;
import p014io.reactivex.internal.operators.single.SingleFlatMap;
import p014io.reactivex.internal.operators.single.SingleFlatMapCompletable;
import p014io.reactivex.internal.operators.single.SingleFlatMapIterableFlowable;
import p014io.reactivex.internal.operators.single.SingleFlatMapIterableObservable;
import p014io.reactivex.internal.operators.single.SingleFlatMapMaybe;
import p014io.reactivex.internal.operators.single.SingleFlatMapPublisher;
import p014io.reactivex.internal.operators.single.SingleFromCallable;
import p014io.reactivex.internal.operators.single.SingleFromPublisher;
import p014io.reactivex.internal.operators.single.SingleFromUnsafeSource;
import p014io.reactivex.internal.operators.single.SingleHide;
import p014io.reactivex.internal.operators.single.SingleInternalHelper;
import p014io.reactivex.internal.operators.single.SingleJust;
import p014io.reactivex.internal.operators.single.SingleLift;
import p014io.reactivex.internal.operators.single.SingleMap;
import p014io.reactivex.internal.operators.single.SingleMaterialize;
import p014io.reactivex.internal.operators.single.SingleNever;
import p014io.reactivex.internal.operators.single.SingleObserveOn;
import p014io.reactivex.internal.operators.single.SingleOnErrorReturn;
import p014io.reactivex.internal.operators.single.SingleResumeNext;
import p014io.reactivex.internal.operators.single.SingleSubscribeOn;
import p014io.reactivex.internal.operators.single.SingleTakeUntil;
import p014io.reactivex.internal.operators.single.SingleTimeout;
import p014io.reactivex.internal.operators.single.SingleTimer;
import p014io.reactivex.internal.operators.single.SingleToFlowable;
import p014io.reactivex.internal.operators.single.SingleToObservable;
import p014io.reactivex.internal.operators.single.SingleUnsubscribeOn;
import p014io.reactivex.internal.operators.single.SingleUsing;
import p014io.reactivex.internal.operators.single.SingleZipArray;
import p014io.reactivex.internal.operators.single.SingleZipIterable;
...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @SchedulerSupport("none")
    /* renamed from: as */
    public final <R> R mo25753as(SingleConverter<T, ? extends R> singleConverter) {
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R mo25828to(Function<? super Single<T>, R> function) {
        try {
