...
public final class CompletableConcatArray extends Completable {
    ...
    public void subscribeActual(CompletableObserver completableObserver) {
        ...
        completableObserver.onSubscribe(concatInnerObserver.f1096sd);
    ...
    static final class ConcatInnerObserver extends AtomicInteger implements CompletableObserver {
        ...
        /* renamed from: sd */
        final SequentialDisposable f1096sd = new SequentialDisposable();
        final CompletableSource[] sources;
        ...
        public void onSubscribe(Disposable disposable) {
            this.f1096sd.replace(disposable);
        }
        ...
        public void next() {
            if (!this.f1096sd.isDisposed() && getAndIncrement() == 0) {
                CompletableSource[] completableSourceArr = this.sources;
                while (!this.f1096sd.isDisposed()) {
                    int i = this.index;
                    this.index = i + 1;
