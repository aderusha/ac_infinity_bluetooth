                ...
                while (!this.cancelled) {
                    ...
                    if (!z || (th2 = equalObserver.error) == null) {
                        ...
                        if (!z2 || (th = equalObserver2.error) == null) {
                            if (this.f1146v1 == null) {
                                this.f1146v1 = spscLinkedArrayQueue.poll();
                            }
                            boolean z3 = this.f1146v1 == null;
                            if (this.f1147v2 == null) {
                                this.f1147v2 = spscLinkedArrayQueue2.poll();
                            }
                            T t = this.f1147v2;
                            boolean z4 = t == null;
                            if (z && z2 && z3 && z4) {
                                ...
                                if (!z3 && !z4) {
                                    try {
                                        if (!this.comparer.test(this.f1146v1, t)) {
