...
import p014io.reactivex.parallel.ParallelFailureHandling;
...
public final class ParallelMapTry<T, R> extends ParallelFlowable<R> {
    ...
    static final class ParallelMapTrySubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0008:
                ...
                java.lang.Object r10 = p014io.reactivex.internal.functions.ObjectHelper.requireNonNull(r4, (java.lang.String) r5)     // Catch:{ all -> 0x001b }
                org.reactivestreams.Subscriber<? super R> r1 = r9.downstream
                r1.onNext(r10)
                return r0
            L_0x001b:
                r4 = move-exception
                p014io.reactivex.exceptions.Exceptions.throwIfFatal(r4)
                r5 = 2
                ...
                java.lang.Object r6 = p014io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x0052 }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p014io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x0052 }
                int[] r7 = p014io.reactivex.internal.operators.parallel.ParallelMapTry.C37931.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x0052:
                r10 = move-exception
                p014io.reactivex.exceptions.Exceptions.throwIfFatal(r10)
                r9.cancel()
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p014io.reactivex.internal.operators.parallel.ParallelMapTry.ParallelMapTrySubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static /* synthetic */ class C37931 {
        ...
        static {
            /*
                io.reactivex.parallel.ParallelFailureHandling[] r0 = p014io.reactivex.parallel.ParallelFailureHandling.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$io$reactivex$parallel$ParallelFailureHandling = r0
                io.reactivex.parallel.ParallelFailureHandling r1 = p014io.reactivex.parallel.ParallelFailureHandling.RETRY     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$io$reactivex$parallel$ParallelFailureHandling     // Catch:{ NoSuchFieldError -> 0x001d }
                io.reactivex.parallel.ParallelFailureHandling r1 = p014io.reactivex.parallel.ParallelFailureHandling.SKIP     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$io$reactivex$parallel$ParallelFailureHandling     // Catch:{ NoSuchFieldError -> 0x0028 }
                io.reactivex.parallel.ParallelFailureHandling r1 = p014io.reactivex.parallel.ParallelFailureHandling.STOP     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p014io.reactivex.internal.operators.parallel.ParallelMapTry.C37931.<clinit>():void");
        }
    }
    ...
    static final class ParallelMapTryConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0008:
                ...
                java.lang.Object r10 = p014io.reactivex.internal.functions.ObjectHelper.requireNonNull(r0, (java.lang.String) r4)     // Catch:{ all -> 0x001b }
            ...
            L_0x001b:
                ...
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r6 = p014io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x0053 }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p014io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x0053 }
                int[] r7 = p014io.reactivex.internal.operators.parallel.ParallelMapTry.C37931.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x0053:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p014io.reactivex.internal.operators.parallel.ParallelMapTry.ParallelMapTryConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }
