    ...
    static final class ParallelDoOnNextSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0014:
                ...
                java.lang.Object r6 = p014io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x004b }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p014io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x004b }
                int[] r7 = p014io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C37911.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x004b:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p014io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.ParallelDoOnNextSubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static /* synthetic */ class C37911 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p014io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C37911.<clinit>():void");
        }
    }
    ...
    static final class ParallelDoOnNextConditionalSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0014:
                ...
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r6 = p014io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x004c }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p014io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x004c }
                int[] r7 = p014io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C37911.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x004c:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p014io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.ParallelDoOnNextConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }
