...
public enum NotificationLite {
    ...
    static final class ErrorNotification implements Serializable {
        ...
        public String toString() {
            return "NotificationLite.Error[" + this.f1186e + "]";
        }
        ...
        public boolean equals(Object obj) {
            if (obj instanceof ErrorNotification) {
                return ObjectHelper.equals(this.f1186e, ((ErrorNotification) obj).f1186e);
            }
            return false;
        }
    }
    ...
    public static Throwable getError(Object obj) {
        return ((ErrorNotification) obj).f1186e;
    }
    ...
    public static <T> boolean accept(Object obj, Subscriber<? super T> subscriber) {
        if (obj == COMPLETE) {
            ...
            subscriber.onError(((ErrorNotification) obj).f1186e);
            return true;
        } else {
    ...
    public static <T> boolean accept(Object obj, Observer<? super T> observer) {
        if (obj == COMPLETE) {
            ...
            observer.onError(((ErrorNotification) obj).f1186e);
            return true;
        } else {
            observer.onNext(obj);
            return false;
