...
public final class ExecutorScheduler extends Scheduler {
    ...
    public static final class ExecutorWorker extends Scheduler.Worker implements Runnable {
        ...
        public void run() {
            ...
            L_0x0025:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p014io.reactivex.internal.schedulers.ExecutorScheduler.ExecutorWorker.run():void");
        }
    ...
    final class DelayedDispose implements Runnable {
        ...
        /* renamed from: dr */
        private final DelayedRunnable f1165dr;

        DelayedDispose(DelayedRunnable delayedRunnable) {
            this.f1165dr = delayedRunnable;
        }

        public void run() {
            this.f1165dr.direct.replace(ExecutorScheduler.this.scheduleDirect(this.f1165dr));
        }
    }
}
