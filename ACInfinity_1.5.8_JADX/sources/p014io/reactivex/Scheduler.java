...
import p014io.reactivex.internal.schedulers.NewThreadWorker;
import p014io.reactivex.internal.schedulers.SchedulerWhen;
import p014io.reactivex.internal.util.ExceptionHelper;
import p014io.reactivex.plugins.RxJavaPlugins;
import p014io.reactivex.schedulers.SchedulerRunnableIntrospection;
        ...
        final class PeriodicTask implements Runnable, SchedulerRunnableIntrospection {
            ...
            public void run() {
                ...
                if (!this.f1076sd.isDisposed()) {
                    ...
                    this.f1076sd.replace(Worker.this.schedule(this, j - now, TimeUnit.NANOSECONDS));
                }
            }
