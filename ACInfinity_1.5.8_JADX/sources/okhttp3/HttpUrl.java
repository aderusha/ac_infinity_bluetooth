...
public final class HttpUrl {
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        int i = C39701.$SwitchMap$okhttp3$HttpUrl$Builder$ParseResult[parse.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i != 2) {
    ...
    static /* synthetic */ class C39701 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.HttpUrl.C39701.<clinit>():void");
        }
    }
