...
final class Http2Reader implements Closeable {
    ...
    interface Handler {
        ...
        void headers(boolean z, int i, int i2, List<C3987Header> list);

        void ping(boolean z, int i, int i2);

        void priority(int i, int i2, int i3, boolean z);

        void pushPromise(int i, int i2, List<C3987Header> list) throws IOException;
    ...
    private List<C3987Header> readHeaderBlock(int i, short s, byte b, int i2) throws IOException {
