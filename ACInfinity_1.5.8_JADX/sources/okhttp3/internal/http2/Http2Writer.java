...
final class Http2Writer implements Closeable {
    ...
    public synchronized void pushPromise(int i, int i2, List<C3987Header> list) throws IOException {
        if (!this.closed) {
    ...
    public synchronized void synStream(boolean z, int i, int i2, List<C3987Header> list) throws IOException {
        if (!this.closed) {
            headers(z, i, list);
        } else {
            throw new IOException("closed");
    ...
    public synchronized void synReply(boolean z, int i, List<C3987Header> list) throws IOException {
        if (!this.closed) {
            headers(z, i, list);
        } else {
            throw new IOException("closed");
    ...
    public synchronized void headers(int i, List<C3987Header> list) throws IOException {
        if (!this.closed) {
    ...
    /* access modifiers changed from: package-private */
    public void headers(boolean z, int i, List<C3987Header> list) throws IOException {
        if (!this.closed) {
            this.hpackWriter.writeHeaders(list);
            long size = this.hpackBuffer.size();
