    ...
    class RelaySource implements Source {
        ...
        public long read(okio.Buffer r22, long r23) throws java.io.IOException {
            /*
                ...
                monitor-enter(r4)
            L_0x000b:
                long r5 = r1.sourcePos     // Catch:{ all -> 0x0135 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0135 }
                long r7 = r0.upstreamPos     // Catch:{ all -> 0x0135 }
                r0 = 2
                r9 = -1
                int r11 = (r5 > r7 ? 1 : (r5 == r7 ? 0 : -1))
                if (r11 != 0) goto L_0x0039
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0135 }
                boolean r5 = r5.complete     // Catch:{ all -> 0x0135 }
                if (r5 == 0) goto L_0x0020
                monitor-exit(r4)     // Catch:{ all -> 0x0135 }
                return r9
            L_0x0020:
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0135 }
                java.lang.Thread r5 = r5.upstreamReader     // Catch:{ all -> 0x0135 }
                if (r5 == 0) goto L_0x002e
                okio.Timeout r0 = r1.timeout     // Catch:{ all -> 0x0135 }
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0135 }
                r0.waitUntilNotified(r5)     // Catch:{ all -> 0x0135 }
                goto L_0x000b
            L_0x002e:
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0135 }
                java.lang.Thread r6 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x0135 }
                r5.upstreamReader = r6     // Catch:{ all -> 0x0135 }
                r5 = 1
                monitor-exit(r4)     // Catch:{ all -> 0x0135 }
                goto L_0x004b
            L_0x0039:
                ...
                long r5 = r7 - r5
                long r11 = r1.sourcePos     // Catch:{ all -> 0x0135 }
            ...
            L_0x011b:
                long r7 = r7 - r11
                long r2 = java.lang.Math.min(r2, r7)     // Catch:{ all -> 0x0135 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0135 }
                okio.Buffer r9 = r0.buffer     // Catch:{ all -> 0x0135 }
                long r7 = r1.sourcePos     // Catch:{ all -> 0x0135 }
                long r11 = r7 - r5
                r10 = r22
                r13 = r2
                r9.copyTo((okio.Buffer) r10, (long) r11, (long) r13)     // Catch:{ all -> 0x0135 }
                long r5 = r1.sourcePos     // Catch:{ all -> 0x0135 }
                long r5 = r5 + r2
                r1.sourcePos = r5     // Catch:{ all -> 0x0135 }
                monitor-exit(r4)     // Catch:{ all -> 0x0135 }
                return r2
            L_0x0135:
                r0 = move-exception
