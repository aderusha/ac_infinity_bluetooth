...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:35:0x011d A[Catch:{ all -> 0x0114 }] */
    /* JADX WARNING: Removed duplicated region for block: B:37:0x0123 A[Catch:{ all -> 0x0114 }] */
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        /*
            ...
            r2 = 0
            java.net.Socket r3 = r7.rawSocket     // Catch:{ AssertionError -> 0x0116 }
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x0116 }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x0116 }
            okhttp3.HttpUrl r5 = r0.url()     // Catch:{ AssertionError -> 0x0116 }
            int r5 = r5.port()     // Catch:{ AssertionError -> 0x0116 }
            r6 = 1
            java.net.Socket r1 = r1.createSocket(r3, r4, r5, r6)     // Catch:{ AssertionError -> 0x0116 }
            javax.net.ssl.SSLSocket r1 = (javax.net.ssl.SSLSocket) r1     // Catch:{ AssertionError -> 0x0116 }
            okhttp3.ConnectionSpec r8 = r8.configureSecureSocket(r1)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            boolean r3 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            if (r3 == 0) goto L_0x0041
            okhttp3.internal.platform.Platform r3 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.util.List r5 = r0.protocols()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            r3.configureTlsExtensions(r1, r4, r5)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
        L_0x0041:
            r1.startHandshake()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            javax.net.ssl.SSLSession r3 = r1.getSession()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            boolean r4 = r7.isValid(r3)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            if (r4 == 0) goto L_0x0106
            okhttp3.Handshake r4 = okhttp3.Handshake.get(r3)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            javax.net.ssl.HostnameVerifier r5 = r0.hostnameVerifier()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            okhttp3.HttpUrl r6 = r0.url()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r6 = r6.host()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            boolean r3 = r5.verify(r6, r3)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            if (r3 == 0) goto L_0x00b4
            okhttp3.CertificatePinner r3 = r0.certificatePinner()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.util.List r5 = r4.peerCertificates()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            r3.check((java.lang.String) r0, (java.util.List<java.security.cert.Certificate>) r5)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            boolean r8 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            if (r8 == 0) goto L_0x0085
            okhttp3.internal.platform.Platform r8 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r2 = r8.getSelectedProtocol(r1)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
        L_0x0085:
            r7.socket = r1     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            okio.Source r8 = okio.Okio.source((java.net.Socket) r1)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            okio.BufferedSource r8 = okio.Okio.buffer((okio.Source) r8)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            r7.source = r8     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            okio.Sink r8 = okio.Okio.sink((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            okio.BufferedSink r8 = okio.Okio.buffer((okio.Sink) r8)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            r7.sink = r8     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            r7.handshake = r4     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            if (r2 == 0) goto L_0x00a6
            okhttp3.Protocol r8 = okhttp3.Protocol.get(r2)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            goto L_0x00a8
        L_0x00a6:
            okhttp3.Protocol r8 = okhttp3.Protocol.HTTP_1_1     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
        L_0x00a8:
            r7.protocol = r8     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
        ...
        L_0x00b3:
            return
        L_0x00b4:
            java.util.List r8 = r4.peerCertificates()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            r2 = 0
            java.lang.Object r8 = r8.get(r2)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.security.cert.X509Certificate r8 = (java.security.cert.X509Certificate) r8     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            javax.net.ssl.SSLPeerUnverifiedException r2 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            r3.<init>()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r4 = "Hostname "
            r3.append(r4)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            r3.append(r0)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r0 = " not verified:\n    certificate: "
            r3.append(r0)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r0 = okhttp3.CertificatePinner.pin(r8)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            r3.append(r0)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r0 = "\n    DN: "
            r3.append(r0)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.security.Principal r0 = r8.getSubjectDN()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r0 = r0.getName()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            r3.append(r0)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r0 = "\n    subjectAltNames: "
            r3.append(r0)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.util.List r8 = okhttp3.internal.tls.OkHostnameVerifier.allSubjectAltNames(r8)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            r3.append(r8)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r8 = r3.toString()     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            r2.<init>(r8)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            throw r2     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
        L_0x0106:
            java.io.IOException r8 = new java.io.IOException     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            java.lang.String r0 = "a valid ssl session was not established"
            r8.<init>(r0)     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
            throw r8     // Catch:{ AssertionError -> 0x0111, all -> 0x010e }
        L_0x010e:
            r8 = move-exception
            r2 = r1
            goto L_0x0124
        ...
        L_0x0116:
            r8 = move-exception
        L_0x0117:
            boolean r0 = okhttp3.internal.Util.isAndroidGetsocknameError(r8)     // Catch:{ all -> 0x0114 }
            if (r0 == 0) goto L_0x0123
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x0114 }
            r0.<init>(r8)     // Catch:{ all -> 0x0114 }
