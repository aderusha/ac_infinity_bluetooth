...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m2214getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m1022boximpl(obj);
            notifyAll();
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result2 == null) {
                    ...
                    ResultKt.throwOnFailure(result2.m1032unboximpl());
                }
            }
        }
    }
