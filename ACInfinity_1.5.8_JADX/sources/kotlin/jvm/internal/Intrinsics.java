...
public class Intrinsics {
    ...
    public static void checkReturnedValueIsNotNull(Object obj, String str, String str2) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Method specified as non-null returned null: " + str + Consts.DOT + str2)));
        }
    }
    ...
    public static void checkFieldIsNotNull(Object obj, String str, String str2) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Field specified as non-null is null: " + str + Consts.DOT + str2)));
        }
    }
    ...
    private static String createParameterIsNullExceptionMessage(String str) {
        ...
        return "Parameter specified as non-null is null: method " + className + Consts.DOT + methodName + ", parameter " + str;
    }
