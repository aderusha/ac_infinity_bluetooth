...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    private final Continuation<Object> crossFunctionCompletion(Function3<? super DeepRecursiveScope<?, ?>, Object, ? super Continuation<Object>, ? extends Object> function3, Continuation<Object> continuation) {
        return new C3807x3ce6e4bb(EmptyCoroutineContext.INSTANCE, this, function3, continuation);
    }
    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (continuation == null) {
                ...
                return r;
            } else if (Result.m1025equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                try {
                    ...
                    if (function3 != null) {
                        ...
                        if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            continuation.resumeWith(Result.m1023constructorimpl(invoke));
                        }
                    } else {
