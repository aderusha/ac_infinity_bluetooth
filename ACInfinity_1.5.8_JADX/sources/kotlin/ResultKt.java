...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> function0) {
        try {
            ...
            return Result.m1023constructorimpl(function0.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m1023constructorimpl(createFailure(th));
        }
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> function1) {
        try {
            Result.Companion companion = Result.Companion;
            return Result.m1023constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m1023constructorimpl(createFailure(th));
        }
    ...
    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> function1) {
        if (!Result.m1030isSuccessimpl(obj)) {
            return Result.m1023constructorimpl(obj);
        }
        Result.Companion companion = Result.Companion;
        return Result.m1023constructorimpl(function1.invoke(obj));
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        Result.Companion companion = Result.Companion;
        return Result.m1023constructorimpl(function1.invoke(r0));
    }
