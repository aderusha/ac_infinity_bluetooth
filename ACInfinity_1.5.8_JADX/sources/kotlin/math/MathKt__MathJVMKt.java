...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m1004ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m1005ln(float f) {
