...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    ModernAsyncTask() {
        C04252 r0 = new WorkerRunnable<Params, Result>() {
    ...
    static /* synthetic */ class C04274 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.loader.content.ModernAsyncTask.C04274.<clinit>():void");
        }
    }

    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.mStatus != Status.PENDING) {
            int i = C04274.$SwitchMap$androidx$loader$content$ModernAsyncTask$Status[this.mStatus.ordinal()];
            if (i == 1) {
