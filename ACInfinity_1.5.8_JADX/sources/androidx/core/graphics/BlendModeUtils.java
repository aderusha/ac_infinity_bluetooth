    ...
    static /* synthetic */ class C01851 {
        ...
        static {
            ...
            L_0x015c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.BlendModeUtils.C01851.<clinit>():void");
        }
    }

    static BlendMode obtainBlendModeFromCompat(BlendModeCompat blendModeCompat) {
        switch (C01851.$SwitchMap$androidx$core$graphics$BlendModeCompat[blendModeCompat.ordinal()]) {
            case 1:
