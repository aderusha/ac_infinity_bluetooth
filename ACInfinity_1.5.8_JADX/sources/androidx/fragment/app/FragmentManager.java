...
public abstract class FragmentManager {
    ...
    static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0317R.C0320id.fragment_container_view_tag);
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ...
        if (fragmentContainer != null) {
            if (fragmentContainer.getTag(C0317R.C0320id.visible_removing_fragment_view_tag) == null) {
                fragmentContainer.setTag(C0317R.C0320id.visible_removing_fragment_view_tag, fragment);
            }
            ((Fragment) fragmentContainer.getTag(C0317R.C0320id.visible_removing_fragment_view_tag)).setNextAnim(fragment.getNextAnim());
        }
    }
