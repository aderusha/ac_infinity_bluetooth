...
class FragmentAnim {
    ...
    static AnimationOrAnimator loadAnimation(Context context, FragmentContainer fragmentContainer, Fragment fragment, boolean z) {
        ...
        if (!(onFindViewById == null || onFindViewById.getTag(C0317R.C0320id.visible_removing_fragment_view_tag) == null)) {
            onFindViewById.setTag(C0317R.C0320id.visible_removing_fragment_view_tag, (Object) null);
        }
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C0317R.anim.fragment_open_enter : C0317R.anim.fragment_open_exit;
        }
        if (i != 4099) {
            if (i != 8194) {
                return -1;
            }
            return z ? C0317R.anim.fragment_close_enter : C0317R.anim.fragment_close_exit;
        } else if (z) {
            return C0317R.anim.fragment_fade_enter;
        } else {
            return C0317R.anim.fragment_fade_exit;
        }
    }
