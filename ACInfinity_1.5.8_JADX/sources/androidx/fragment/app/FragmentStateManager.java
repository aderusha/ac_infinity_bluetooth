...
class FragmentStateManager {
    ...
    public int computeMaxState() {
        ...
        int i2 = C03421.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()];
        if (i2 == 1) {
            return i;
        }
        if (i2 == 2) {
    ...
    static /* synthetic */ class C03421 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.FragmentStateManager.C03421.<clinit>():void");
        }
    }
    ...
    public void createView(androidx.fragment.app.FragmentContainer r5) {
        ...
        L_0x00b4:
            ...
            androidx.fragment.app.Fragment r5 = r4.mFragment
            android.view.View r5 = r5.mView
            int r2 = androidx.fragment.C0317R.C0320id.fragment_container_view_tag
