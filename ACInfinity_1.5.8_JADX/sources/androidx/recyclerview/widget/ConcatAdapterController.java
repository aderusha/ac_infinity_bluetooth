...
class ConcatAdapterController implements NestedAdapterWrapper.Callback {
    ...
    private final ConcatAdapter.C0594Config.StableIdMode mStableIdMode;
    ...
    ConcatAdapterController(ConcatAdapter concatAdapter, ConcatAdapter.C0594Config config) {
        ...
        if (config.stableIdMode == ConcatAdapter.C0594Config.StableIdMode.NO_STABLE_IDS) {
            this.mStableIdStorage = new StableIdStorage.NoStableIdStorage();
        } else if (config.stableIdMode == ConcatAdapter.C0594Config.StableIdMode.ISOLATED_STABLE_IDS) {
            this.mStableIdStorage = new StableIdStorage.IsolatedStableIdStorage();
        } else if (config.stableIdMode == ConcatAdapter.C0594Config.StableIdMode.SHARED_STABLE_IDS) {
    ...
    public int getTotalCount() {
        ...
        for (NestedAdapterWrapper cachedItemCount : this.mWrappers) {
            i += cachedItemCount.getCachedItemCount();
        }
        return i;
    }
    ...
    public boolean hasStableIds() {
        return this.mStableIdMode != ConcatAdapter.C0594Config.StableIdMode.NO_STABLE_IDS;
    }
