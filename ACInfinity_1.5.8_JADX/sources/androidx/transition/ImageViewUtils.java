...
class ImageViewUtils {
    ...
    static void startAnimateTransform(ImageView imageView) {
        if (Build.VERSION.SDK_INT < 21) {
            ...
            imageView.setTag(C0753R.C0756id.save_scale_type, scaleType);
            if (scaleType == ImageView.ScaleType.MATRIX) {
                imageView.setTag(C0753R.C0756id.save_image_matrix, imageView.getImageMatrix());
            } else {
        ...
        if (Build.VERSION.SDK_INT < 21) {
            animator.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animator) {
                    ImageView.ScaleType scaleType = (ImageView.ScaleType) imageView.getTag(C0753R.C0756id.save_scale_type);
                    imageView.setScaleType(scaleType);
                    imageView.setTag(C0753R.C0756id.save_scale_type, (Object) null);
                    if (scaleType == ImageView.ScaleType.MATRIX) {
                        ImageView imageView = imageView;
                        imageView.setImageMatrix((Matrix) imageView.getTag(C0753R.C0756id.save_image_matrix));
                        imageView.setTag(C0753R.C0756id.save_image_matrix, (Object) null);
                    }
