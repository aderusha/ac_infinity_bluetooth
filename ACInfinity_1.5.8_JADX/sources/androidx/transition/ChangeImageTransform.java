    ...
    static /* synthetic */ class C07413 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C07413.<clinit>():void");
        }
    }

    private static Matrix copyImageMatrix(ImageView imageView) {
        int i = C07413.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
        if (i == 1) {
