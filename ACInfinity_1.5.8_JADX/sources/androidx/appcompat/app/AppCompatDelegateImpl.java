...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private AppCompatDelegateImpl(android.content.Context r3, android.view.Window r4, androidx.appcompat.app.AppCompatCallback r5, java.lang.Object r6) {
        ...
        L_0x0032:
            ...
            java.util.Map<java.lang.Class<?>, java.lang.Integer> r3 = sLocalNightModes
        ...
        if (obtainStyledAttributes.hasValue(C0041R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    viewGroup = (ViewGroup) from.inflate(C0041R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null);
                } else {
                    viewGroup = (ViewGroup) from.inflate(C0041R.layout.abc_screen_simple, (ViewGroup) null);
                }
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (view == null) {
                        ...
                        view2.setBackgroundColor(this.mContext.getResources().getColor(C0041R.C0042color.abc_input_method_navigation_guard));
