...
public final class TableInfo {
    ...
    private static Index readIndex(SupportSQLiteDatabase supportSQLiteDatabase, String str, boolean z) {
        ...
        try {
            ...
            int columnIndex3 = query.getColumnIndex(SerializableCookie.NAME);
            ...
            if (!(columnIndex == -1 || columnIndex2 == -1 || columnIndex3 == -1)) {
                if (columnIndex4 != -1) {
                    ...
                    Index index = new Index(str, z, arrayList, arrayList2);
                    query.close();
                    return index;
                }
            }
    ...
    public static final class Column {
        ...
        public boolean equals(Object obj) {
            ...
            if ((i == 0 || i != column.mCreatedFrom || ((str = this.defaultValue) == null ? column.defaultValue == null : defaultValueEquals(str, column.defaultValue))) && this.affinity == column.affinity) {
                return true;
            }
            return false;
        }
