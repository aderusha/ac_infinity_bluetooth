...
import androidx.swiperefreshlayout.C0713R;
...
class CircleImageView extends ImageView {
    ...
    CircleImageView(Context context) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(C0713R.styleable.SwipeRefreshLayout);
        this.mBackgroundColor = obtainStyledAttributes.getColor(C0713R.styleable.f67xaa980688, DEFAULT_BACKGROUND_COLOR);
