...
final class PagedListAdapter$withLoadStateHeaderAndFooter$1 extends Lambda implements Function2<LoadType, LoadState, Unit> {
    final /* synthetic */ LoadStateAdapter $footer;
    final /* synthetic */ LoadStateAdapter $header;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PagedListAdapter$withLoadStateHeaderAndFooter$1(LoadStateAdapter loadStateAdapter, LoadStateAdapter loadStateAdapter2) {
        super(2);
