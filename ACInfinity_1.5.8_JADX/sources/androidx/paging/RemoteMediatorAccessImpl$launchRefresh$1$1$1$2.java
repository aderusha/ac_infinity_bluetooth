...
final class RemoteMediatorAccessImpl$launchRefresh$1$1$1$2 extends Lambda implements Function1<AccessorState<Key, Value>, Boolean> {
    ...
    RemoteMediatorAccessImpl$launchRefresh$1$1$1$2(RemoteMediator.MediatorResult mediatorResult) {
        super(1);
    ...
    public final boolean invoke(AccessorState<Key, Value> accessorState) {
        ...
        accessorState.setError(LoadType.REFRESH, new LoadState.Error(((RemoteMediator.MediatorResult.Error) this.$loadResult).getThrowable()));
