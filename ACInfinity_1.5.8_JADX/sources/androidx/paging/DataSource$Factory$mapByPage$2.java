...
final class DataSource$Factory$mapByPage$2<I, O> implements Function<List<? extends Value>, List<? extends ToValue>> {
    final /* synthetic */ Function1 $function;

    DataSource$Factory$mapByPage$2(Function1 function1) {
