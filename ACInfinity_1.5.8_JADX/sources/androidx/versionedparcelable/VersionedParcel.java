...
import com.telink.p010lt.ble.PropertyResolver;
...
public abstract class VersionedParcel {
    ...
    private Method getReadMethod(String str) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        Method declaredMethod = Class.forName(str, true, cls.getClassLoader()).getDeclaredMethod(PropertyResolver.READ, new Class[]{cls});
    ...
    private Method getWriteMethod(Class cls) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        System.currentTimeMillis();
        Method declaredMethod = findParcelClass.getDeclaredMethod(PropertyResolver.WRITE, new Class[]{cls, VersionedParcel.class});
