...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f77CR = 13;

    /* renamed from: LF */
    private static final byte f78LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f79in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f79in) {
            if (this.buf != null) {
                ...
                C08841 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f79in;
        byte[] bArr = this.buf;
