...
public class RequestBuilder<TranscodeType> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    protected RequestBuilder(Glide glide2, RequestManager requestManager2, Class<TranscodeType> cls, Context context2) {
        ...
        RequestOptions defaultRequestOptions2 = requestManager2.getDefaultRequestOptions();
        ...
        this.requestOptions = defaultRequestOptions2;
    ...
    public <Y extends Target<TranscodeType>> Y into(Y y, RequestListener<TranscodeType> requestListener) {
        return into(y, requestListener, getMutableOptions());
    }

    private <Y extends Target<TranscodeType>> Y into(Y y, RequestListener<TranscodeType> requestListener, RequestOptions requestOptions2) {
    ...
    public ViewTarget<ImageView, TranscodeType> into(ImageView imageView) {
        ...
        if (!requestOptions2.isTransformationSet() && requestOptions2.isTransformationAllowed() && imageView.getScaleType() != null) {
            switch (C08802.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
                case 1:
        ...
        return (ViewTarget) into(this.glideContext.buildImageViewTarget(imageView, this.transcodeClass), (RequestListener) null, requestOptions2);
    }
    ...
    static /* synthetic */ class C08802 {
        ...
        static {
            ...
            L_0x008f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.RequestBuilder.C08802.<clinit>():void");
        }
    }

    private Priority getThumbnailPriority(Priority priority) {
        int i = C08802.$SwitchMap$com$bumptech$glide$Priority[priority.ordinal()];
        if (i == 1) {
    ...
    private Request buildRequest(Target<TranscodeType> target, RequestListener<TranscodeType> requestListener, RequestOptions requestOptions2) {
        return buildRequestRecursive(target, requestListener, (RequestCoordinator) null, this.transitionOptions, requestOptions2.getPriority(), requestOptions2.getOverrideWidth(), requestOptions2.getOverrideHeight(), requestOptions2);
    }

    private Request buildRequestRecursive(Target<TranscodeType> target, RequestListener<TranscodeType> requestListener, RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions2, Priority priority, int i, int i2, RequestOptions requestOptions2) {
    ...
    private Request buildThumbnailRequestRecursive(Target<TranscodeType> target, RequestListener<TranscodeType> requestListener, RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions2, Priority priority, int i, int i2, RequestOptions requestOptions2) {
        ...
        if (requestBuilder != null) {
            if (!this.isThumbnailBuilt) {
                ...
                Priority priority3 = requestBuilder.requestOptions.isPrioritySet() ? this.thumbnailBuilder.requestOptions.getPriority() : getThumbnailPriority(priority2);
                ...
                Request buildRequestRecursive = requestBuilder2.buildRequestRecursive(target, requestListener, thumbnailRequestCoordinator, transitionOptions3, priority3, overrideWidth, overrideHeight, requestBuilder2.requestOptions);
            ...
            int i3 = i;
            int i4 = i2;
            thumbnailRequestCoordinator3.setRequests(obtainRequest(target, requestListener2, requestOptions2, thumbnailRequestCoordinator4, transitionOptions4, priority, i3, i4), obtainRequest(target, requestListener2, requestOptions2.clone().sizeMultiplier(this.thumbSizeMultiplier.floatValue()), thumbnailRequestCoordinator4, transitionOptions4, getThumbnailPriority(priority2), i3, i4));
