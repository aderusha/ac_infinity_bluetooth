...
public final class Util {
    ...
    private static int getBytesPerPixel(Bitmap.Config config) {
        ...
        int i = C09281.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 1;
        }
        if (i == 2 || i == 3) {
    ...
    static /* synthetic */ class C09281 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.util.Util.C09281.<clinit>():void");
        }
    }
