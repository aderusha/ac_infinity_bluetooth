...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    private static Bitmap.Config[] getInConfigs(Bitmap.Config config) {
        ...
        int i = C08991.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C08991 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.bitmap_recycle.SizeConfigStrategy.C08991.<clinit>():void");
        }
    }
}
