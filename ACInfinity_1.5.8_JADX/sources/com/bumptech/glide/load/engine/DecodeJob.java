...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, FactoryPools.Poolable {
    ...
    public void run() {
        /*
            ...
            boolean r2 = r5.isCancelled     // Catch:{ all -> 0x0027 }
            if (r2 == 0) goto L_0x001b
            r5.notifyFailed()     // Catch:{ all -> 0x0027 }
        ...
        L_0x0017:
            ...
            return
        L_0x001b:
            r5.runWrapped()     // Catch:{ all -> 0x0027 }
        ...
        L_0x0027:
            r2 = move-exception
            r3 = 3
            boolean r3 = android.util.Log.isLoggable(r0, r3)     // Catch:{ all -> 0x0066 }
            ...
            boolean r4 = r5.isCancelled     // Catch:{ all -> 0x0066 }
            r3.append(r4)     // Catch:{ all -> 0x0066 }
            java.lang.String r4 = ", stage: "
            r3.append(r4)     // Catch:{ all -> 0x0066 }
            com.bumptech.glide.load.engine.DecodeJob$Stage r4 = r5.stage     // Catch:{ all -> 0x0066 }
            r3.append(r4)     // Catch:{ all -> 0x0066 }
            java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0066 }
            android.util.Log.d(r0, r3, r2)     // Catch:{ all -> 0x0066 }
        L_0x004f:
            com.bumptech.glide.load.engine.DecodeJob$Stage r0 = r5.stage     // Catch:{ all -> 0x0066 }
            com.bumptech.glide.load.engine.DecodeJob$Stage r3 = com.bumptech.glide.load.engine.DecodeJob.Stage.ENCODE     // Catch:{ all -> 0x0066 }
            if (r0 == r3) goto L_0x005d
            java.util.List<java.lang.Throwable> r0 = r5.throwables     // Catch:{ all -> 0x0066 }
            r0.add(r2)     // Catch:{ all -> 0x0066 }
            r5.notifyFailed()     // Catch:{ all -> 0x0066 }
        L_0x005d:
            boolean r0 = r5.isCancelled     // Catch:{ all -> 0x0066 }
    ...
    private void runWrapped() {
        int i = C08901.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$RunReason[this.runReason.ordinal()];
        if (i == 1) {
    ...
    private DataFetcherGenerator getNextGenerator() {
        int i = C08901.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[this.stage.ordinal()];
        if (i == 1) {
    ...
    private Stage getNextStage(Stage stage2) {
        int i = C08901.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[stage2.ordinal()];
        if (i == 1) {
    ...
    public <Z> com.bumptech.glide.load.engine.Resource<Z> onResourceDecoded(com.bumptech.glide.load.DataSource r12, com.bumptech.glide.load.engine.Resource<Z> r13) {
        ...
        L_0x0042:
            ...
            int[] r12 = com.bumptech.glide.load.engine.DecodeJob.C08901.$SwitchMap$com$bumptech$glide$load$EncodeStrategy
            int r1 = r13.ordinal()
            r12 = r12[r1]
    ...
    static /* synthetic */ class C08901 {
        ...
        static {
            ...
            L_0x007e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.DecodeJob.C08901.<clinit>():void");
        }
    }
