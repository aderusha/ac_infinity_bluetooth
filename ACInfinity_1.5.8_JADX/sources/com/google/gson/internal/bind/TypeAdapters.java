...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r1, com.google.gson.reflect.TypeToken<T> r2) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C351528.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            ...
            public java.util.BitSet read(com.google.gson.stream.JsonReader r8) throws java.io.IOException {
                ...
                L_0x000e:
                    ...
                    int[] r4 = com.google.gson.internal.bind.TypeAdapters.C352334.$SwitchMap$com$google$gson$stream$JsonToken
                    int r5 = r1.ordinal()
                    r4 = r4[r5]
                    r5 = 1
                ...
                L_0x0075:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C35062.read(com.google.gson.stream.JsonReader):java.util.BitSet");
            }
        ...
        C35173 r0 = new TypeAdapter<Boolean>() {
            public Boolean read(JsonReader jsonReader) throws IOException {
        ...
        C35255 r02 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C35266 r03 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C35277 r04 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C350014 r05 = new TypeAdapter<Character>() {
        ...
        C350115 r06 = new TypeAdapter<String>() {
        ...
        C350418 r07 = new TypeAdapter<StringBuilder>() {
        ...
        C350519 r08 = new TypeAdapter<StringBuffer>() {
        ...
        C350720 r09 = new TypeAdapter<URL>() {
        ...
        C350821 r010 = new TypeAdapter<URI>() {
        ...
        C350922 r011 = new TypeAdapter<InetAddress>() {
        ...
        C351023 r012 = new TypeAdapter<UUID>() {
        ...
        C351225 r013 = new TypeAdapter<Calendar>() {
        ...
        C351326 r014 = new TypeAdapter<Locale>() {
        ...
        C351427 r015 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof JsonTreeReader) {
                    return ((JsonTreeReader) jsonReader).nextJsonElement();
                }
                switch (C352334.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C352334 {
        ...
        static {
            ...
            L_0x0078:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C352334.<clinit>():void");
        }
    }
