...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f314C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f315C2 = 5545529020109919103L;
        ...
        private void bmix64(long j, long j2) {
            long mixK1 = mixK1(j) ^ this.f316h1;
            this.f316h1 = mixK1;
            long rotateLeft = Long.rotateLeft(mixK1, 27);
            this.f316h1 = rotateLeft;
            long j3 = this.f317h2;
            long j4 = rotateLeft + j3;
            this.f316h1 = j4;
            this.f316h1 = (j4 * 5) + 1390208809;
            long mixK2 = mixK2(j2) ^ j3;
            this.f317h2 = mixK2;
            long rotateLeft2 = Long.rotateLeft(mixK2, 31);
            this.f317h2 = rotateLeft2;
            long j5 = rotateLeft2 + this.f316h1;
            this.f317h2 = j5;
            this.f317h2 = (j5 * 5) + 944331445;
        }
        ...
        public HashCode makeHash() {
            ...
            long j2 = j ^ ((long) i);
            this.f316h1 = j2;
            long j3 = this.f317h2 ^ ((long) i);
            this.f317h2 = j3;
            long j4 = j2 + j3;
            this.f316h1 = j4;
            this.f317h2 = j3 + j4;
            this.f316h1 = fmix64(j4);
            long fmix64 = fmix64(this.f317h2);
            this.f317h2 = fmix64;
            long j5 = this.f316h1 + fmix64;
            this.f316h1 = j5;
            this.f317h2 = fmix64 + j5;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f316h1).putLong(this.f317h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f314C1, 31) * f315C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f315C2, 33) * f314C1;
        }
    }
}
