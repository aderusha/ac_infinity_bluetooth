...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    /* renamed from: C1 */
    private static final int f318C1 = -862048943;

    /* renamed from: C2 */
    private static final int f319C2 = 461845907;
    ...
    public static int mixK1(int i) {
        return Integer.rotateLeft(i * f318C1, 15) * f319C2;
    }
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int i, long j) {
            ...
            this.length += i;
            if (i3 >= 32) {
                this.f320h1 = Murmur3_32HashFunction.mixH1(this.f320h1, Murmur3_32HashFunction.mixK1((int) j3));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            int access$000 = this.f320h1 ^ Murmur3_32HashFunction.mixK1((int) this.buffer);
            this.f320h1 = access$000;
