...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N n, N n2, E e) {
        ...
        if (containsEdge(e)) {
            ...
            EndpointPair of = EndpointPair.m217of((Network<?, ?>) this, n, n2);
    ...
    private NetworkConnections<N, E> newConnections() {
        if (isDirected()) {
            if (allowsParallelEdges()) {
                return DirectedMultiNetworkConnections.m214of();
            }
            return DirectedNetworkConnections.m215of();
        } else if (allowsParallelEdges()) {
            return UndirectedMultiNetworkConnections.m220of();
        } else {
            return UndirectedNetworkConnections.m221of();
        }
    }
}
