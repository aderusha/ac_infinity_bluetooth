...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m99on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m99on('=').trimResults();
    ...
    public CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C29801.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] == 1) {
                newBuilder.weakKeys();
            } else {
        ...
        if (this.valueStrength != null) {
            int i = C29801.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.valueStrength.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C29801 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.cache.CacheBuilderSpec.C29801.<clinit>():void");
        }
    }
