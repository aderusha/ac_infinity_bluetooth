...
public final class ImmutableIntArray implements Serializable {
    ...
    /* renamed from: of */
    public static ImmutableIntArray m238of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static ImmutableIntArray m239of(int i) {
        return new ImmutableIntArray(new int[]{i});
    }

    /* renamed from: of */
    public static ImmutableIntArray m240of(int i, int i2) {
        return new ImmutableIntArray(new int[]{i, i2});
    }

    /* renamed from: of */
    public static ImmutableIntArray m241of(int i, int i2, int i3) {
        return new ImmutableIntArray(new int[]{i, i2, i3});
    }

    /* renamed from: of */
    public static ImmutableIntArray m242of(int i, int i2, int i3, int i4) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4});
    }

    /* renamed from: of */
    public static ImmutableIntArray m243of(int i, int i2, int i3, int i4, int i5) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5});
    }

    /* renamed from: of */
    public static ImmutableIntArray m244of(int i, int i2, int i3, int i4, int i5, int i6) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5, i6});
    }

    /* renamed from: of */
    public static ImmutableIntArray m245of(int i, int... iArr) {
