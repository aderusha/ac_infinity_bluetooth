...
public final class DoubleMath {
    ...
    static double roundIntermediate(double d, RoundingMode roundingMode) {
        if (DoubleUtils.isFinite(d)) {
            switch (C33191.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C33191 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.DoubleMath.C33191.<clinit>():void");
        }
    }
