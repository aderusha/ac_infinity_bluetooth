...
public final class IntMath {
    ...
    static final int[] powersOf10 = {1, 10, 100, 1000, 10000, BuglyStrategy.C3610a.MAX_USERDATA_VALUE_LENGTH, DurationKt.NANOS_IN_MILLIS, 10000000, 100000000, 1000000000};
    ...
    static /* synthetic */ class C33201 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.IntMath.C33201.<clinit>():void");
        }
    }

    public static int log2(int i, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", i);
        switch (C33201.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static int log10(int r3, java.math.RoundingMode r4) {
        /*
            ...
            int[] r1 = powersOf10
            r1 = r1[r0]
            int[] r2 = com.google.common.math.IntMath.C33201.$SwitchMap$java$math$RoundingMode
            int r4 = r4.ordinal()
            r4 = r2[r4]
            switch(r4) {
    ...
    public static int sqrt(int r2, java.math.RoundingMode r3) {
        /*
            ...
            int r0 = sqrtFloor(r2)
            int[] r1 = com.google.common.math.IntMath.C33201.$SwitchMap$java$math$RoundingMode
            int r3 = r3.ordinal()
            r3 = r1[r3]
            switch(r3) {
    ...
    public static int divide(int r5, int r6, java.math.RoundingMode r7) {
        ...
        L_0x000e:
            ...
            r2 = 1
            r5 = r5 | r2
            int[] r3 = com.google.common.math.IntMath.C33201.$SwitchMap$java$math$RoundingMode
            int r4 = r7.ordinal()
            r3 = r3[r4]
            r4 = 0
            switch(r3) {
