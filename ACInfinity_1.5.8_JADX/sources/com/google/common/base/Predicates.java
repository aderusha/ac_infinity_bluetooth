...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m94or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m95or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy((T[]) predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m93or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m92in(Collection<? extends T> collection) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f285f;

        /* renamed from: p */
        final Predicate<B> f286p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f286p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f285f = (Function) Preconditions.checkNotNull(function);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f286p.apply(this.f285f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f285f.equals(compositionPredicate.f285f) || !this.f286p.equals(compositionPredicate.f286p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f285f.hashCode() ^ this.f286p.hashCode();
        }

        public String toString() {
            return this.f286p + "(" + this.f285f + ")";
        }
    }
