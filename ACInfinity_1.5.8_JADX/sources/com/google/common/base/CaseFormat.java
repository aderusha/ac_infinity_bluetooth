...
public enum CaseFormat {
    LOWER_HYPHEN(CharMatcher.m80is('-'), "-") {
    ...
    LOWER_UNDERSCORE(CharMatcher.m80is('_'), "_") {
        /* access modifiers changed from: package-private */
        public String normalizeWord(String str) {
            return Ascii.toLowerCase(str);
        }
    ...
    UPPER_UNDERSCORE(CharMatcher.m80is('_'), "_") {
        /* access modifiers changed from: package-private */
        public String normalizeWord(String str) {
            return Ascii.toUpperCase(str);
        }
    ...
    /* renamed from: to */
    public final String mo18454to(CaseFormat caseFormat, String str) {
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doForward(String str) {
            return this.sourceFormat.mo18454to(this.targetFormat, str);
        }

        /* access modifiers changed from: protected */
        public String doBackward(String str) {
            return this.targetFormat.mo18454to(this.sourceFormat, str);
        }
