...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m80is(char c) {
        return new C2947Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m80is(charSequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo18475or(CharMatcher charMatcher) {
        return new C2948Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m80is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    private static final class C2948Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C2948Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C2947Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo18475or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo18475or(charMatcher);
        }
