...
public class CycleDetectingLockFactory {
    ...
    private static String getLockName(Enum<?> enumR) {
        return enumR.getDeclaringClass().getSimpleName() + Consts.DOT + enumR.name();
    }
    ...
    private static class ExampleStackTrace extends IllegalStateException {
        ...
        static final ImmutableSet<String> EXCLUDED_CLASS_NAMES = ImmutableSet.m162of(CycleDetectingLockFactory.class.getName(), ExampleStackTrace.class.getName(), LockGraphNode.class.getName());
