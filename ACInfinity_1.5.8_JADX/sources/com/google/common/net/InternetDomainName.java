...
public final class InternetDomainName {
    ...
    private static final Joiner DOT_JOINER = Joiner.m86on('.');
    private static final Splitter DOT_SPLITTER = Splitter.m99on('.');
    ...
    static {
        ...
        DASH_MATCHER = anyOf;
        PART_CHAR_MATCHER = CharMatcher.javaLetterOrDigit().mo18475or(anyOf);
    }
    ...
    InternetDomainName(String str) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m88of(PublicSuffixType.REGISTRY));
    }
    ...
    public InternetDomainName child(String str) {
        return from(((String) Preconditions.checkNotNull(str)) + Consts.DOT + this.name);
    }
