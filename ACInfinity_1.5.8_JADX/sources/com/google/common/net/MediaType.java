...
public final class MediaType {
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m87on("; ").withKeyValueSeparator("=");
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m131of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static MediaType createConstant(String str, String str2) {
        MediaType addKnownType = addKnownType(new MediaType(str, str2, ImmutableListMultimap.m130of()));
    ...
    private static MediaType createConstantUtf8(String str, String str2) {
        ...
        addKnownType.parsedCharset = Optional.m88of(Charsets.UTF_8);
        return addKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    optional = Optional.m88of(Charset.forName(str2));
                    str = str2;
    ...
    public MediaType withParameter(String str, String str2) {
        return withParameters(str, ImmutableSet.m160of(str2));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType withParameter = withParameter(CHARSET_ATTRIBUTE, charset.name());
        withParameter.parsedCharset = Optional.m88of(charset);
    ...
    /* renamed from: is */
    public boolean mo22104is(MediaType mediaType) {
    ...
    public static MediaType create(String str, String str2) {
        MediaType create = create(str, str2, ImmutableListMultimap.m130of());
