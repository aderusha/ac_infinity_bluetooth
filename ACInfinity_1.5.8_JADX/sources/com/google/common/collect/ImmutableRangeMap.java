...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    private static final ImmutableRangeMap<Comparable<?>, Object> EMPTY = new ImmutableRangeMap<>(ImmutableList.m117of(), ImmutableList.m117of());
    ...
    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m155of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m156of(Range<K> range, V v) {
        return new ImmutableRangeMap<>(ImmutableList.m118of(range), ImmutableList.m118of(v));
    }
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        return new ImmutableRangeMap<K, V>(new ImmutableList<Range<K>>() {
            ...
            public ImmutableRangeMap<K, V> subRangeMap(Range<K> range) {
                ...
                return ImmutableRangeMap.m155of();
            }
        };
    }
