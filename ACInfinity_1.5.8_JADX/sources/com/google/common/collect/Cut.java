...
abstract class Cut<C extends Comparable> implements Comparable<Cut<C>>, Serializable {
    ...
    private static final class BelowValue<C extends Comparable> extends Cut<C> {
        ...
        public Cut<C> withLowerBoundType(BoundType boundType, DiscreteDomain<C> discreteDomain) {
            int i = C30361.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()];
            if (i == 1) {
                return this;
            }
            if (i == 2) {
    ...
    static /* synthetic */ class C30361 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.Cut.C30361.<clinit>():void");
        }
    }
