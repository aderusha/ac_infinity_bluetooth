...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m166of() {
        return EmptyImmutableSetMultimap.INSTANCE;
    }

    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m167of(K k, V v) {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m168of(K k, V v, K k2, V v2) {
        Builder builder = builder();
        builder.put((Object) k, (Object) v);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m169of(K k, V v, K k2, V v2, K k3, V v3) {
        Builder builder = builder();
        builder.put((Object) k, (Object) v);
        builder.put((Object) k2, (Object) v2);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m170of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        Builder builder = builder();
        builder.put((Object) k, (Object) v);
        builder.put((Object) k2, (Object) v2);
        builder.put((Object) k3, (Object) v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSetMultimap<K, V> m171of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        Builder builder = builder();
        builder.put((Object) k, (Object) v);
        builder.put((Object) k2, (Object) v2);
        builder.put((Object) k3, (Object) v3);
