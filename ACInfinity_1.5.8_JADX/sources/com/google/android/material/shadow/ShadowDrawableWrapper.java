...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        super(drawable);
        this.shadowStartColor = ContextCompat.getColor(context, C2855R.C2856color.design_fab_shadow_start_color);
        this.shadowMiddleColor = ContextCompat.getColor(context, C2855R.C2856color.design_fab_shadow_mid_color);
        this.shadowEndColor = ContextCompat.getColor(context, C2855R.C2856color.design_fab_shadow_end_color);
    ...
    private void drawShadow(Canvas canvas) {
        ...
        canvas2.drawPath(this.cornerShadowPath, this.cornerShadowPaint);
        if (z2) {
            canvas2.scale(SHADOW_BOTTOM_SCALE / f14, SHADOW_BOTTOM_SCALE);
            canvas.drawRect(0.0f, f6, this.contentBounds.height() - f7, -this.cornerRadius, this.edgeShadowPaint);
        }
    ...
    private void buildShadowCorners() {
        ...
        if (f3 > 0.0f) {
            ...
            RadialGradient radialGradient2 = new RadialGradient(0.0f, 0.0f, f3, new int[]{0, this.shadowStartColor, this.shadowMiddleColor, this.shadowEndColor}, new float[]{0.0f, f4, ((SHADOW_BOTTOM_SCALE - f4) / 2.0f) + f4, 1.0f}, Shader.TileMode.CLAMP);
