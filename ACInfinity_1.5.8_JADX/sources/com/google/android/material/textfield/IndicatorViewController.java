...
final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = (float) context2.getResources().getDimensionPixelSize(C2855R.dimen.design_textinput_caption_translate_y);
    }
    ...
    public void setErrorEnabled(boolean z) {
        if (this.errorEnabled != z) {
            ...
            if (z) {
                ...
                appCompatTextView.setId(C2855R.C2858id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        if (this.helperTextEnabled != z) {
            ...
            if (z) {
                ...
                appCompatTextView.setId(C2855R.C2858id.textinput_helper_text);
                Typeface typeface2 = this.typeface;
                if (typeface2 != null) {
