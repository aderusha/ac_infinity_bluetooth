...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C2855R.layout.design_bottom_sheet_dialog, (ViewGroup) null);
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) frameLayout.findViewById(C2855R.C2858id.coordinator);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, coordinatorLayout, false);
        }
        FrameLayout frameLayout2 = (FrameLayout) coordinatorLayout.findViewById(C2855R.C2858id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C2855R.C2858id.touch_outside).setOnClickListener(new View.OnClickListener() {
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        if (context.getTheme().resolveAttribute(C2855R.attr.bottomSheetDialogTheme, typedValue, true)) {
            return typedValue.resourceId;
        }
        return C2855R.style.Theme_Design_Light_BottomSheetDialog;
    }
}
