...
class FloatingActionButtonImpl {
    ...
    private MotionSpec getDefaultShowMotionSpec() {
        if (this.defaultShowMotionSpec == null) {
            this.defaultShowMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C2855R.animator.design_fab_show_motion_spec);
        }
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        if (this.defaultHideMotionSpec == null) {
            this.defaultHideMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C2855R.animator.design_fab_hide_motion_spec);
        }
    ...
    public CircularBorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        newCircularDrawable.setGradientColors(ContextCompat.getColor(context, C2855R.C2856color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C2855R.C2856color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C2855R.C2856color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C2855R.C2856color.design_fab_stroke_end_outer_color));
