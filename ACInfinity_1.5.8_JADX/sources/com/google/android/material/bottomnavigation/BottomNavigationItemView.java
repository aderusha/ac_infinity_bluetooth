...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C2855R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C2855R.C2857drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C2855R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C2855R.C2858id.icon);
        TextView textView = (TextView) findViewById(C2855R.C2858id.smallLabel);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C2855R.C2858id.largeLabel);
