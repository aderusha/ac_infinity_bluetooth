...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C2855R.attr.snackbarStyle};
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C2855R.layout.mtrl_layout_snackbar : C2855R.layout.design_layout_snackbar;
    }
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(C2855R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) obtainStyledAttributes.getDimensionPixelSize(C2855R.styleable.SnackbarLayout_elevation, 0));
            }
            obtainStyledAttributes.recycle();
            ...
            C29201 r4 = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() {
