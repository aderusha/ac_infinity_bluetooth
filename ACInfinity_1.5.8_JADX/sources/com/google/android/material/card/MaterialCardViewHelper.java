...
class MaterialCardViewHelper {
    ...
    public void loadFromAttributes(TypedArray typedArray) {
        this.strokeColor = typedArray.getColor(C2855R.styleable.MaterialCardView_strokeColor, -1);
        this.strokeWidth = typedArray.getDimensionPixelSize(C2855R.styleable.MaterialCardView_strokeWidth, 0);
        updateForeground();
