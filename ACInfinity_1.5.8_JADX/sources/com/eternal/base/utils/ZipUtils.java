        ...
        while (true) {
            ...
            if (nextEntry != null) {
                ...
                if (nextEntry.isDirectory()) {
                    ...
                    KLog.m66e(TAG, str2 + File.separator + name);
                    File file = new File(str2 + File.separator + name);
                    if (!file.exists()) {
                        KLog.m66e(TAG, "Create the file:" + str2 + File.separator + name);
    ...
    public static void UnZipFolder(String str, String str2, String str3) throws Exception {
        ...
        while (true) {
            ...
            if (nextEntry == null) {
                ...
                KLog.m66e(TAG, str2 + File.separator + str3);
                File file = new File(str2 + File.separator + str3);
                if (!file.exists()) {
                    KLog.m66e(TAG, "Create the file:" + str2 + File.separator + str3);
                    file.getParentFile().mkdirs();
                    file.createNewFile();
                }
                FileOutputStream fileOutputStream = new FileOutputStream(file);
